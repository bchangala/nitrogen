...
def calcSCF(H, labels = None, init_wfs = None, target = None, 
        ...
        """
        Calculate the self-consistent field wavefunctions.

        Parameters
        ----------
        H : TensorOperator
            The Hamiltonian as a tensor operator
        ...
        while cnt < maxiter:
            ...
            for i in range(len(wfs)):
                ...
                bra = TensorNetwork(bra_tensors, bra_labels)
                ...
                vwfs[i] = u.reshape((nh,) + wfs[i].shape)
                ve[i] = w 
